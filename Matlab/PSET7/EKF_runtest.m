...
sim_constants.mu0 = [0;sin(pi/6);0;cos(pi/6);deg2rad([0.1; 0.1; 2.5]);0;0;0;0;0;0;0;0]; % initial estimate
sim_constants.cov0 = 4*eye(15); % initial covariance
...
figure('Name','\omega Bias Estimate'); hold on;
...
figure('Name','Magnetometer Bias Estimate'); hold on;
...
figure('Name','Sun Sensor Bias Estimate'); hold on;
labs = {'b_{az}', 'b_{el}'};
for i = 1:2
   subplot(1,2,i); hold on;
